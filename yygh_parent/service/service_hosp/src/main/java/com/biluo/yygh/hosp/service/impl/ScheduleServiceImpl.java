...
import com.biluo.yygh.hosp.mapper.ScheduleMapper;
import com.biluo.yygh.hosp.repository.ScheduleRepository;
...
import com.biluo.yygh.model.hosp.BookingRule;
...
import com.biluo.yygh.vo.hosp.BookingScheduleRuleVo;
...
public class ScheduleServiceImpl extends ServiceImpl<ScheduleMapper, Schedule> implements ScheduleService {
	...
	public Map<String, Object> getBookingScheduleRule(int page, int limit, String hoscode, String depcode) {
		...
		if (ObjectUtils.isNotEmpty(scheduleVoList)) {
