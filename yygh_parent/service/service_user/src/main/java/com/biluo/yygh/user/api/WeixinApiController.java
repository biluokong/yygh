...
import com.biluo.yygh.user.config.WxConfig;
import com.biluo.yygh.user.service.UserInfoService;
import com.biluo.yygh.user.utils.HttpClientUtils;
...
public class WeixinApiController {
	...
	public String callback(String code, String state) {
		...
		try {
			...
			map.put("token", token);
			// 跳转到前端页面
			return "redirect:" + wxConfig.getBaseUrl() + "/weixin/callback?token=" +
	...
	public Result<Map<String, Object>> genQrConnect() {
		try {
			...
			String wxOpenRedirectUrl = wxConfig.getRedirectUrl();
